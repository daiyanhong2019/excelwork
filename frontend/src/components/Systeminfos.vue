<template>
    <div class="container">
                        ...
                        <tr v-for="(systeminfo, index) in systeminfos" :key="index">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-warning btn-sm" v-b-modal.systeminfo-modal @click="updatesysteminfo(systeminfo)">Update</button>
        ...
        <b-modal ref="addSystemInfoModal" id="editsysteminfo-modal" title="Edit systeminfo" hide-footer>
    ...
    methods: {
        ...
        onReset(evt) {
         ...
         updatesysteminfo(systeminfo) {
            this.addSystemInfoForm.systemkey = systeminfo.systemkey
            this.addSystemInfoForm.systemname = systeminfo.systemname
            this.addSystemInfoForm.selecteddomain = systeminfo.domain
            this.addSystemInfoForm.selectedstate = systeminfo.releasestate
            // const payload = {
            //     systemkey: this.addSystemInfoForm.systemkey,
            //     systemname: this.addSystemInfoForm.systemname,
            //     releasestate: this.addSystemInfoForm.selectedstate,
